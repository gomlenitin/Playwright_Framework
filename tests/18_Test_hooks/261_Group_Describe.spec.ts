...
// If we run the test.describe it will run sequentially
...
// If we run the test.describe it will run parallely - NOT in order
test.describe.parallel('Checkout suite — must run parallel', () => {
    test('open landing', async () => { console.log('1'); });
    test('search product', async () => { console.log('2'); });
    test('add to cart', async () => { console.log('3'); });
    test('go to checkout', async () => { console.log('4'); });
